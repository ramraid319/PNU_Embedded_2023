...
static void LCD_WR_REG(uint16_t LCD_Reg)
{
	...
	GPIO_ResetBits(GPIOD, GPIO_Pin_13); //LCD_DC Low
	GPIO_ResetBits(GPIOC, GPIO_Pin_8); //LCD_CS Low
	GPIO_ResetBits(GPIOB, GPIO_Pin_14); //LCD_WR Low

	GPIO_Write(GPIOE, LCD_Reg);
	// TODO implement using GPIO_ResetBits/GPIO_SetBits
	GPIO_SetBits(GPIOC, GPIO_Pin_8); //LCD_CS High
	GPIO_SetBits(GPIOB, GPIO_Pin_14); //LCD_WR High
...
{
	// TODO implement using GPIO_ResetBits/GPIO_SetBits
	GPIO_SetBits(GPIOD, GPIO_Pin_13); //LCD_DC High
	GPIO_ResetBits(GPIOC, GPIO_Pin_8); //LCD_CS Low
	GPIO_ResetBits(GPIOB, GPIO_Pin_14); //LCD_WR Low
